...
-- Dumping database structure for jualrumah
CREATE DATABASE IF NOT EXISTS `jualrumah` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `jualrumah`;

-- Dumping structure for table jualrumah.ci_sessions
...
-- Dumping data for table jualrumah.ci_sessions: ~0 rows (approximately)
DELETE FROM `ci_sessions`;
/*!40000 ALTER TABLE `ci_sessions` DISABLE KEYS */;
/*!40000 ALTER TABLE `ci_sessions` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_admin
CREATE TABLE IF NOT EXISTS `tbl_admin` (
  ...
  `superadmin` enum('Y','N') DEFAULT 'N',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Dumping data for table jualrumah.tbl_admin: ~0 rows (approximately)
DELETE FROM `tbl_admin`;
/*!40000 ALTER TABLE `tbl_admin` DISABLE KEYS */;
INSERT INTO `tbl_admin` (`id`, `last_login`, `email`, `nama_lengkap`, `user_name`, `password`, `superadmin`) VALUES
	(1, '0000-00-00 00:00:00', 'jualrumahbwi@yahoo.com', 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Y');
/*!40000 ALTER TABLE `tbl_admin` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_admin_messages
CREATE TABLE IF NOT EXISTS `tbl_admin_messages` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
  `pesan` text,
  `tgl` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `from_member` enum('Y','N') DEFAULT 'N',
  `id_member` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table jualrumah.tbl_admin_messages: ~0 rows (approximately)
DELETE FROM `tbl_admin_messages`;
/*!40000 ALTER TABLE `tbl_admin_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_admin_messages` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_bookmark
CREATE TABLE IF NOT EXISTS `tbl_bookmark` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `id_listing` int(10) DEFAULT NULL,
  `id_member` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Dumping data for table jualrumah.tbl_bookmark: ~2 rows (approximately)
DELETE FROM `tbl_bookmark`;
/*!40000 ALTER TABLE `tbl_bookmark` DISABLE KEYS */;
INSERT INTO `tbl_bookmark` (`id`, `id_listing`, `id_member`) VALUES
	(2, 1, 4);
/*!40000 ALTER TABLE `tbl_bookmark` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_comments
...
-- Dumping data for table jualrumah.tbl_comments: ~9 rows (approximately)
DELETE FROM `tbl_comments`;
/*!40000 ALTER TABLE `tbl_comments` DISABLE KEYS */;
INSERT INTO `tbl_comments` (`id`, `id_member`, `id_listing`, `insert_at`, `comment`) VALUES
	(1, 4, 1, '2013-08-29 14:56:15', 'ini\r\nadalah komentar\r\nyang sangaaaaaat\r\npanjang'),
	(2, 4, 1, '2013-08-29 16:38:26', 'lalala'),
	(3, 4, 1, '2013-08-29 16:46:55', 'lalala'),
	(4, 4, 1, '2013-08-29 17:18:45', 'lalalalal'),
	(5, 4, 1, '2013-08-29 17:19:29', 'ini adalah test'),
	(6, 10, 1, '2013-08-29 17:21:43', 'ini adalah test lagi'),
	(7, 4, 1, '2013-08-29 17:38:09', 'aku adalah owner'),
	(8, 4, 2, '2013-08-29 19:12:41', 'ini adalah test'),
	(9, 4, 18, '2013-09-05 16:35:41', 'hai');
/*!40000 ALTER TABLE `tbl_comments` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_config
CREATE TABLE IF NOT EXISTS `tbl_config` (
  `item` varchar(50) DEFAULT NULL,
  `value` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table jualrumah.tbl_config: ~9 rows (approximately)
DELETE FROM `tbl_config`;
/*!40000 ALTER TABLE `tbl_config` DISABLE KEYS */;
INSERT INTO `tbl_config` (`item`, `value`) VALUES
	('site_title', ''),
	('facebook_link', 'www.facebook.com/jual.rumahku'),
	('office_zip', '68416'),
	('office_address', 'JL. Pajajaran No 54 RT 01/01 Tamanbaru'),
	('office_town', 'Banyuwangi'),
	('cs_phone', '081222333444'),
	('use_email_verification', 'TRUE'),
	('admin_email', 'kirana.avalokiteshvara@gmail.com'),
	('max_image_listing_size', '1024');
/*!40000 ALTER TABLE `tbl_config` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_images
...
-- Dumping data for table jualrumah.tbl_images: ~35 rows (approximately)
DELETE FROM `tbl_images`;
/*!40000 ALTER TABLE `tbl_images` DISABLE KEYS */;
INSERT INTO `tbl_images` (`id`, `file_name`, `listing_id`) VALUES
	(20, '0bf3770c3574f16b43c4ab1b4b2338a3.jpg', 4),
	(23, '2774bfad00cf3c40ec06889fedf8bd72.jpg', 1),
	(24, '7a7e400a1ea0a3b466ed25cf32692c9f.jpg', 5),
	(25, '3b3666bc3284403db1755b6222758a9e.jpg', 5),
	(26, '6b0ce062cbd684c23a88cf5856c816be.jpg', 7),
	(27, '0113332f9f021ce58673227bf88a9dfb.jpg', 7),
	(28, 'b72afed6c815b4c6ff02b1124091a375.jpg', 7),
	(29, '7f8752c2f96c61cf9d54c75e9fc8b028.jpg', 7),
	(30, '26a543e362dcb8decd3852514c7f7170.jpg', 7),
	(31, 'a52390194c89ada64a8d2c5550528b77.jpg', 8),
	(32, 'f7dcc797571d95ec0fb38c19e99c919e.jpg', 8),
	(33, '03f7177b0e7c67b787abff3fc348f50a.jpg', 8),
	(34, '04d1c59625a22c2f31d3508001fa7e9a.jpg', 8),
	(35, '6ee65b4f241aab775f8b5b15e0c0532d.jpg', 8),
	(36, 'a81455bf90b33290d49e601a93342855.jpg', 9),
	(37, '40838a7184eab602ba682bdb11bc743e.jpg', 9),
	(38, '437d8e20882b8f33b631054548e1cee7.jpg', 9),
	(39, '6e5d891ea48299e9809f39c92fae74bb.jpg', 9),
	(40, '8d0fc1175d94f0721802cdcff1a33577.jpg', 9),
	(41, 'ba418e2e331b77cafac18118e14f00f6.jpg', 10),
	(42, 'd10d9f9db519d2c9eb23ea85cb22ee5a.jpg', 10),
	(43, '09f3f211f35ffa9455981435e64e84ba.jpg', 10),
	(44, '8a7ea0de7afef768c7297c1c390a11f0.jpg', 10),
	(45, '3098f5e9ae5e577c1e7fbbd9afbd73b0.jpg', 10),
	(46, 'a334babaf0705d5458b4e7332ae92fe8.jpg', 13),
	(47, '90a3990e6f3ce32b94c100d0b25de9bf.jpg', 13),
	(48, 'ef9578f2e24f8fdc3823c94d4de992cc.jpg', 13),
	(49, 'eb0b97e45e48afe2cd246654ada244bb.jpg', 13),
	(50, 'f32e3f17d0159a6137cadb4720cdc00d.jpg', 13),
	(51, 'd7815ce7888c3dec502dc6d4221b97e7.jpg', 14),
	(52, '9c8761d5f467d2ff9268d09d75e34d4b.jpg', 14),
	(53, '1ea61e9439712241ec31ea1d876f0335.jpg', 14),
	(54, '0bfa72d739535928bf2e0d7f28558ef8.jpg', 14),
	(55, '419a2e8431c01c18df2e3959b24196c8.jpg', 14),
	(56, 'edf0e404e1af9594be1d58cb4d9efd32.jpg', 18);
/*!40000 ALTER TABLE `tbl_images` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_jns_sertifikat
CREATE TABLE IF NOT EXISTS `tbl_jns_sertifikat` (
  `id` tinyint(4) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- Dumping data for table jualrumah.tbl_jns_sertifikat: ~5 rows (approximately)
DELETE FROM `tbl_jns_sertifikat`;
/*!40000 ALTER TABLE `tbl_jns_sertifikat` DISABLE KEYS */;
INSERT INTO `tbl_jns_sertifikat` (`id`, `nama`) VALUES
	(1, 'Hak Milik'),
	(2, 'Hak Guna Bangunan'),
	(3, 'Strata'),
	(4, 'Girik'),
	(5, 'Lainnya');
/*!40000 ALTER TABLE `tbl_jns_sertifikat` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_listing
CREATE TABLE IF NOT EXISTS `tbl_listing` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `jenis_iklan` enum('premium','gratis') DEFAULT 'gratis',
  `bukti_pembayaran` varchar(50) DEFAULT NULL,
  `bukti_pembayaran_status` enum('none','pending','ok','error') DEFAULT NULL,
  `tgl_pembayaran` date DEFAULT NULL,
  `premium_tgl_berakhir` date DEFAULT NULL,
  `id_member` smallint(6) DEFAULT NULL,
  `tgl_buat` datetime DEFAULT NULL,
  `is_verified` enum('Y','N') DEFAULT 'N',
  `tgl_terjual` datetime DEFAULT NULL,
  `last_edit` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `tipe_listing` enum('jual','sewa') DEFAULT 'jual',
  `id_tipe_properti` tinyint(4) DEFAULT NULL,
  `judul_listing` varchar(150) DEFAULT NULL,
  `lat` varchar(150) DEFAULT NULL,
  `lng` varchar(150) DEFAULT NULL,
  `deskripsi_listing` text,
  `provinsi` varchar(2) DEFAULT NULL,
  `kabupaten` varchar(4) DEFAULT NULL,
  `kecamatan` varchar(7) DEFAULT NULL,
  `alamat_lengkap` text,
  `tipe_harga` enum('nego','diminta','kisaran') DEFAULT 'diminta',
  `harga` double DEFAULT NULL,
  `satuan_harga` enum('ribu','juta','milyar') DEFAULT 'juta',
  `satuan_sebenarnya` double DEFAULT NULL,
  `id_jns_sertifikat` tinyint(4) DEFAULT NULL,
  `luas_bangunan` float DEFAULT '0' COMMENT 'meter persegi',
  `dimensi_bangunan` varchar(50) DEFAULT NULL COMMENT 'meter x meter',
  `luas_tanah` float DEFAULT '0' COMMENT 'meter persegi',
  `dimensi_tanah` varchar(50) DEFAULT NULL COMMENT 'meter x meter',
  `thn_pembangunan` smallint(6) DEFAULT NULL,
  `jml_kamar_tidur` tinyint(4) DEFAULT '0',
  `jml_kamar_pembantu` tinyint(4) DEFAULT '0',
  `jml_kamar_mandi` tinyint(4) DEFAULT '0',
  `jml_garasi` tinyint(4) DEFAULT '0',
  `jml_carport` tinyint(4) DEFAULT '0',
  `jml_saluran_telp` tinyint(4) DEFAULT '0',
  `jml_lantai` tinyint(4) DEFAULT '0',
  `kondisi` enum('takberperabot','sebagian','lengkap') DEFAULT 'takberperabot',
  `pasokan_listrik` varchar(50) DEFAULT NULL,
  `menghadap` enum('north','neast','nweast','east','weast','seast','sweast','south') DEFAULT NULL COMMENT 'menghadap(pintu depan)',
  `new_house` enum('Y','N') DEFAULT 'N',
  `has_sold` enum('Y','N') DEFAULT 'N',
  `total_dilihat` int(10) DEFAULT '0',
  `verification_code` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1;

-- Dumping data for table jualrumah.tbl_listing: ~10 rows (approximately)
DELETE FROM `tbl_listing`;
/*!40000 ALTER TABLE `tbl_listing` DISABLE KEYS */;
INSERT INTO `tbl_listing` (`id`, `jenis_iklan`, `bukti_pembayaran`, `bukti_pembayaran_status`, `tgl_pembayaran`, `premium_tgl_berakhir`, `id_member`, `tgl_buat`, `is_verified`, `tgl_terjual`, `last_edit`, `tipe_listing`, `id_tipe_properti`, `judul_listing`, `lat`, `lng`, `deskripsi_listing`, `provinsi`, `kabupaten`, `kecamatan`, `alamat_lengkap`, `tipe_harga`, `harga`, `satuan_harga`, `satuan_sebenarnya`, `id_jns_sertifikat`, `luas_bangunan`, `dimensi_bangunan`, `luas_tanah`, `dimensi_tanah`, `thn_pembangunan`, `jml_kamar_tidur`, `jml_kamar_pembantu`, `jml_kamar_mandi`, `jml_garasi`, `jml_carport`, `jml_saluran_telp`, `jml_lantai`, `kondisi`, `pasokan_listrik`, `menghadap`, `new_house`, `has_sold`, `total_dilihat`, `verification_code`) VALUES
	(1, 'premium', '752ab75a7bf43e61d1a1c7d6e47ca575.png', 'ok', NULL, '2017-07-18', 4, '2013-08-06 16:19:58', 'Y', '2013-08-22 05:42:18', '2017-04-19 21:56:33', 'jual', 2, 'Rumah Murah', '-8.23710213811742', '114.35879230499268', 'One of the finest and most elegant houses in South West London - This exceptional example of William and Mary architecture positioned centrally in Richmond has been extended at various times over the last 300 years and now provides the perfect cohesion of traditional and contemporary design. xxx   			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			', '35', '3510', '3510180', 'xxxx', 'nego', 2, 'ribu', 2, 1, 100, '10x10', 100, '10x10', NULL, 1, 1, 2, 1, 0, 0, 0, '', '450', '', 'Y', 'N', 29, 'CUgKEiumuJj1y90Wty3I'),
	(4, 'premium', NULL, 'ok', NULL, '2017-07-17', 10, '2013-08-25 12:17:09', 'Y', NULL, '2017-04-18 16:33:30', 'sewa', 2, 'lalalalala', NULL, NULL, 'lililililililil    			    			    			    			    			    			', '35', '3510', '3510180', 'lulululululu    			    			    			    			    			    			', 'nego', 10, 'juta', 10000000, 1, 100, 'x10', 100, 'x', NULL, 1, 0, 0, 0, 0, 0, 0, '', '2200 watt', '', 'Y', 'N', 9, NULL),
	(5, 'gratis', 'f03e44fb74287457fe3d1076a6e5c643.jpg', 'none', NULL, '2017-06-20', 4, '2013-08-29 13:02:13', 'Y', NULL, '2017-03-29 14:10:30', 'jual', 2, 'sewa rumah bekas presiden', '-8.232642488411395', '114.3656587600708', 'asik sekali lho rumahnya    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			    			', '35', '3510', '3510180', 'jl.xxxxx', 'nego', 2, 'ribu', 2, 1, 100, '10x10', 0, 'x', NULL, 1, 0, 0, 0, 0, 0, 0, '', '450 watt', '', 'Y', 'N', 7, NULL),
	(7, 'premium', NULL, 'ok', NULL, '2017-07-17', 11, '2013-08-29 17:22:45', 'Y', NULL, '2017-04-18 16:33:32', 'jual', 2, 'Rumah Perum Mendut', NULL, NULL, 'Rumah disewakan untuk jangka panjang, posisi rumah dekat dengan pusat kota. Dilengkapi dengan perabotan yang telah disediakan.    			', '35', '3510', '3510180', 'Perum Mendut Blok MC 02 Tamanbaru Banyuwangi    			', 'nego', 12, 'juta', 12000000, 1, 0, NULL, 0, NULL, NULL, 3, 1, 2, 2, 2, 1, 2, 'sebagian', '2200 watt', '', 'N', 'N', 3, 'T14Bx27I3dQRVEsR6VG4'),
	(8, 'gratis', NULL, NULL, NULL, NULL, 12, '2013-08-29 17:50:50', 'Y', NULL, '2017-03-21 22:48:25', 'sewa', 8, 'RUKO SOBO PERMAI', NULL, NULL, 'Ruko yang berlokasi di tengah kota dengan parkiran luas sangat cocok untuk digunakan tempat usaha anda.			    			', '35', '3510', '3510180', 'Jl. Kepiting No. 31-40 Sobo Banyuwangi        			    			', 'diminta', 8, 'juta', 8000000, 1, 200, '20x10', 2200, '200x11', NULL, 1, 0, 1, 0, 10, 10, 2, '', '5500 watt', '', 'Y', 'N', 4, 'KHvKBsuOl5NIGVRzROGX'),
	(9, 'gratis', NULL, NULL, NULL, NULL, 13, '2013-08-29 18:05:51', 'Y', NULL, '2017-03-20 13:05:12', 'jual', 6, 'VILLA AGRO WISTA', NULL, NULL, '    			kjahkldhalkbdlanlda', '35', '3510', '3510180', 'Jl. Lijen Rt.05 Rw.08', 'kisaran', 200, 'juta', 200000000, 1, 0, NULL, 0, NULL, NULL, 3, 0, 3, 2, 2, 1, 1, 'lengkap', '2200 watt', '', 'Y', 'N', 1, '5u4nP8SeA7VYdpQj3uHu'),
	(10, 'premium', NULL, 'ok', NULL, '2017-07-18', 11, '2013-08-29 18:39:00', 'Y', NULL, '2017-04-19 21:56:39', 'jual', 2, 'RUMAH MINIMALIS', NULL, NULL, 'Rumah yang bernuansa minimalis yang sangat cocok bagi anda penggemarkan rumah dengan desain yang sangat simple tetapi terlihat elegan.     			    			    			', '35', '3510', '3510180', 'Dusun Maroon No. 50 Gentengkulon Genteng Banyuwangi    			    			    			', 'nego', 700, 'juta', 700000000, 1, 800, 'x1', 1000, 'x', NULL, 4, 2, 3, 2, 2, 2, 3, '', '3500', 'east', 'Y', 'N', 4, 'hhVsmKcsnlToEx6s2hon'),
	(13, 'premium', NULL, 'ok', NULL, '2017-07-18', 11, '2013-08-29 18:53:31', 'Y', NULL, '2017-04-19 23:07:58', 'jual', 2, 'RUMAH SIMPLE', NULL, NULL, 'Didisain dengan sederhana tetapi terlihat mewah. Sangat cocok untuk hunian keluarga anda    			', '35', '3510', '3510180', 'Dusun Krajan Rt 02 Rw 04 Karangharjo Glenmore Banyuwangi     			', 'diminta', 500, 'juta', 500000000, 1, 0, NULL, 0, NULL, NULL, 3, 1, 2, 1, 1, 1, 2, '', '2200 watt', '', 'Y', 'N', 6, 'PgQCHp5r8DcJB4ok4inz'),
	(14, 'gratis', NULL, NULL, NULL, NULL, 14, '2013-08-29 19:19:11', 'Y', NULL, '2017-04-12 21:45:35', 'sewa', 9, 'KANTOR', NULL, NULL, 'Kantor yang sangat cocok untuk ruang perkantoran yang di desain sangat menarik & elegan    			', '35', '3510', '3510180', 'Jl. Basuki Rachmat No. 25 Ketapang Banyuwangi    			', 'nego', 30, 'juta', 30000000, 1, 0, NULL, 0, NULL, NULL, 0, 0, 5, 6, 6, 3, 1, 'lengkap', '5500 watt', '', 'Y', 'N', 8, 'Fs4rx9hkekDfbVe7hT6Z'),
	(18, 'premium', 'f03e44fb74287457fe3d1076a6e5c643.jpg', 'ok', NULL, '2017-07-18', 11, '2013-08-30 06:09:44', 'Y', NULL, '2017-04-19 23:07:23', 'jual', 2, 'Rumah Elegan', NULL, NULL, 'rumah elegan nan asyik sekali    			', '35', '3510', '3510180', 'Dusun Krajan    			', 'diminta', 450, 'juta', 450000000, 1, 600, '30x20', 700, '35x20', NULL, 2, 1, 2, 1, 1, 1, 2, '', '2200 watt', 'south', 'N', 'N', 15, 'Ft9einFLTvvGz5wZUQ48'),
	(19, 'premium', NULL, 'ok', NULL, '2017-07-17', 4, '2017-04-12 16:56:08', 'Y', NULL, '2017-04-18 16:33:27', 'jual', 2, 'xxx', '-5.410945277946005', '105.17486572265625', 'xxxxxx', '11', '1107', '1107062', 'xxxxx', 'nego', 0, 'ribu', 0, 1, 12, 'x', 12, 'x', NULL, 0, 0, 0, 0, 0, 0, 0, 'takberperabot', NULL, NULL, 'Y', 'N', 0, 'N7AhNX85x7WEoykYoyZI');
/*!40000 ALTER TABLE `tbl_listing` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_member
CREATE TABLE IF NOT EXISTS `tbl_member` (
  ...
  `alamat` text NOT NULL COMMENT 'alamat pribadi',
  `telp` varchar(50) NOT NULL,
  `is_verified` enum('Y','N') NOT NULL DEFAULT 'N',
  `verified_code` varchar(50) DEFAULT NULL,
...
-- Dumping data for table jualrumah.tbl_member: ~6 rows (approximately)
DELETE FROM `tbl_member`;
/*!40000 ALTER TABLE `tbl_member` DISABLE KEYS */;
INSERT INTO `tbl_member` (`id`, `email`, `password`, `nama_depan`, `nama_belakang`, `alamat`, `telp`, `is_verified`, `verified_code`, `banned`, `banned_reason`, `photo`, `created`, `updated`) VALUES
	(4, 'member1@gmail.com', '7ffb7c0047684a10ef7c18be8e7785a0', 'member 1', '-', 'jl.banyuwangi', '630245', 'Y', NULL, 'N', '', '8d342286fa40ed140085bbfdb37fe554.jpg', NULL, '2017-03-14 13:21:09'),
	(10, 'member2@gmail.com', '6f00c14e6898e4d288b575b18aa459b7', 'member 2', '-', '', '6666666', 'Y', NULL, 'N', NULL, NULL, NULL, '2017-03-14 13:21:09'),
	(11, 'member3@gmail.com', 'd865909fd7d1d7e0c67bb4ae529eae52', 'member 3', '-', 'Perum Mendut Blok A 45 Tamanbaru Banyuwangi', '081934766377', 'Y', NULL, 'N', NULL, '068a22973c51a81f5dc69e9842608349.jpg', NULL, '2017-03-14 13:21:09'),
	(12, 'member4@gmail.com', 'ba25d0bfb37e55c998ae42c2202ed9c5', 'member 4', '-', 'Jl. Ciliwung No. 44 Pengantigan Banyuwangi', '03337708705', 'Y', NULL, 'N', '', NULL, NULL, '2017-03-14 13:21:09'),
	(13, 'member5@gmail.com', 'ec32819de4ac8e622a9a1bfae06c95af', 'member 5', '-', '', '082334215359', 'Y', 'g5rQifB1YRDc8U978SdZ', 'N', NULL, NULL, NULL, '2017-03-14 13:21:09'),
	(14, 'member6@gmail.com', 'ee4a2544c8cb5580130e0c7a9c560c59', 'member 6', '-', '', '09865654678', 'Y', '69bafbOgWb6dOQrvWoC7', 'N', NULL, NULL, NULL, '2017-03-14 13:21:09');
/*!40000 ALTER TABLE `tbl_member` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_pasokan_listrik
CREATE TABLE IF NOT EXISTS `tbl_pasokan_listrik` (
  `id` smallint(6) DEFAULT NULL,
  `besar` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table jualrumah.tbl_pasokan_listrik: ~37 rows (approximately)
DELETE FROM `tbl_pasokan_listrik`;
/*!40000 ALTER TABLE `tbl_pasokan_listrik` DISABLE KEYS */;
INSERT INTO `tbl_pasokan_listrik` (`id`, `besar`) VALUES
	(450, '450 watt'),
	(900, '900 watt'),
	(1300, '1300 watt'),
	(2200, '2200 watt'),
	...
	(32767, '85000 watt'),
	(32767, '95000 watt');
/*!40000 ALTER TABLE `tbl_pasokan_listrik` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_pesan
CREATE TABLE IF NOT EXISTS `tbl_pesan` (
  ...
  `id_pengirim` smallint(6) NOT NULL COMMENT 'Jika pengirim adalah member',
  `id_listing` int(11) NOT NULL,
  `pesan` text NOT NULL,
  `from_admin` enum('Y','N') NOT NULL DEFAULT 'N',
  `has_readed` enum('Y','N') NOT NULL DEFAULT 'N',
  `from_member` enum('Y','N') NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

-- Dumping data for table jualrumah.tbl_pesan: ~2 rows (approximately)
DELETE FROM `tbl_pesan`;
/*!40000 ALTER TABLE `tbl_pesan` DISABLE KEYS */;
INSERT INTO `tbl_pesan` (`id`, `id_user`, `tgl_pesan`, `nama_pengirim`, `email_pengirim`, `telp`, `id_penerima`, `id_pengirim`, `id_listing`, `pesan`, `from_admin`, `has_readed`, `from_member`) VALUES
	(1, NULL, '2013-08-20 00:51:36', 'triasfahrudin', 'triasfahrudin@gmail.com', '630245', 4, 0, 1, 'test ajah', 'N', 'N', 'N'),
	(6, NULL, '2013-08-23 21:20:23', 'admin', 'admin@jualrumah.com', '', 8, 0, 0, 'test ajah lho ya', 'Y', 'N', 'N');
/*!40000 ALTER TABLE `tbl_pesan` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_tipe_properti
CREATE TABLE IF NOT EXISTS `tbl_tipe_properti` (
  `id` tinyint(4) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table jualrumah.tbl_tipe_properti: ~12 rows (approximately)
DELETE FROM `tbl_tipe_properti`;
/*!40000 ALTER TABLE `tbl_tipe_properti` DISABLE KEYS */;
INSERT INTO `tbl_tipe_properti` (`id`, `id_parent`, `nama`) VALUES
	(1, 0, 'Tempat Tinggal'),
	(2, 1, 'Rumah'),
	(3, 1, 'Apartemen'),
	(5, 1, 'Tanah'),
	...
	(11, 7, 'Gudang'),
	(12, 7, 'Ruang Usaha');
/*!40000 ALTER TABLE `tbl_tipe_properti` ENABLE KEYS */;

-- Dumping structure for table jualrumah.tbl_viewed
...
-- Dumping data for table jualrumah.tbl_viewed: ~64 rows (approximately)
DELETE FROM `tbl_viewed`;
/*!40000 ALTER TABLE `tbl_viewed` DISABLE KEYS */;
INSERT INTO `tbl_viewed` (`id`, `ip`, `listing_id`, `viewed_at`) VALUES
	(16, '::1', 1, '2013-08-07'),
	(17, '::1', 1, '2013-08-15'),
	(18, '::1', 1, '2013-08-17'),
	(19, '::1', 2, '2013-08-17'),
	...
	(70, '::1', 10, '2013-09-05'),
	(71, '::1', 4, '2013-09-05'),
	(72, '169.254.236.12', 18, '2013-09-06'),
	(73, '169.254.189.213', 5, '2013-09-06'),
	(74, '169.254.236.12', 14, '2013-09-06'),
	(75, '169.254.82.28', 1, '2013-09-06'),
	(76, '169.254.82.28', 18, '2013-09-06'),
	(77, '169.254.189.213', 14, '2013-09-06'),
	(78, '::1', 1, '2013-09-10'),
	(79, '::1', 18, '2016-12-09'),
	(80, '::1', 1, '2016-12-09'),
	(81, '::1', 8, '2016-12-09'),
...
-- Dumping structure for table jualrumah.t_kabupaten
...
-- Dumping data for table jualrumah.t_kabupaten: ~499 rows (approximately)
DELETE FROM `t_kabupaten`;
/*!40000 ALTER TABLE `t_kabupaten` DISABLE KEYS */;
INSERT INTO `t_kabupaten` (`id`, `provinsi_id`, `name`) VALUES
...
/*!40000 ALTER TABLE `t_kabupaten` ENABLE KEYS */;

-- Dumping structure for table jualrumah.t_kecamatan
...
-- Dumping data for table jualrumah.t_kecamatan: ~6,858 rows (approximately)
DELETE FROM `t_kecamatan`;
/*!40000 ALTER TABLE `t_kecamatan` DISABLE KEYS */;
INSERT INTO `t_kecamatan` (`id`, `kabupaten_id`, `name`) VALUES
...
-- Dumping structure for table jualrumah.t_provinsi
...
-- Dumping data for table jualrumah.t_provinsi: ~34 rows (approximately)
DELETE FROM `t_provinsi`;
/*!40000 ALTER TABLE `t_provinsi` DISABLE KEYS */;
INSERT INTO `t_provinsi` (`id`, `name`) VALUES
	('11', 'Aceh'),
	('12', 'Sumatera Utara'),
	('13', 'Sumatera Barat'),
	('14', 'Riau'),
...
-- Dumping structure for trigger jualrumah.tbl_listing_before_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tbl_listing_before_update` BEFORE UPDATE ON `tbl_listing` FOR EACH ROW BEGIN
	IF(NEW.bukti_pembayaran_status = 'ok') THEN
		SET NEW.jenis_iklan = 'premium';
		SET NEW.premium_tgl_berakhir =  DATE_ADD(NOW(), INTERVAL 90 DAY);
		SET NEW.is_verified = 'Y';
	ELSE
		SET NEW.jenis_iklan = 'gratis';
	END IF;
END//
DELIMITER ;
