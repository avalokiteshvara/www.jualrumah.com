																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						Ada properti baru yang perlu dilakukan verifikasi
																					</div>
																				</td>
																			</tr>
																		</table>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Notifikasi Properti Baru</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">www.jualrumah.com</h2>
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					-->
																					<h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Detail Properti</h3>
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Berikut ini adalah detail properti baru yang perlu diverifikasi.</div>
																					<hr />
																					<table border="0" cellpadding="0" cellspacing="0" width="100%">
																						<tr>
																							<td>Link</td>
																							<td><a target="_blank" href="<?php echo site_url('property/show/' . $listing['id'])?>">Lihat</a></td>
																						</tr>
																						<tr>
																							<td>Tanggal</td>
																							<td><?php echo $listing['tgl_buat']?></td>
																						</tr>
																						<tr>
																							<td>Jual / Sewa</td>
																							<td><?php echo $listing['tipe_listing']?></td>
																						</tr>
																						<tr>
																							<td>Jenis Properti</td>
																							<td><?php echo $listing['jenis_properti']?></td>
																						</tr>
																						<tr>
																							<td>Judul</td>
																							<td><?php echo $listing['judul_listing']?></td>
																						</tr>
																						<tr>
																							<td>Lokasi</td>
																							<td><?php echo $listing['lokasi'] ?></td>
																						</tr>
																					</table>
																				</td>
																			</tr>
										...
										<tr style="padding-top:0;">
											<td align="center" valign="top">
												...
												<table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
													<tr>
														<td style="padding-top:10;" align="center" valign="top" width="500" class="flexibleContainerCell">

															<!-- CONTENT TABLE // -->
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%" href="<?php echo site_url('admin/login')?>" target="_blank">Login Admin</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
