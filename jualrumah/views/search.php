   ...
   <div class="span4">
      ...
      <div class="row">
         ...
         <div class="span3 well">
			...
			<div class="row">
				<!-- <img src="<?php echo load_image('uploads/iklan-1.jpg',260,220)?>" style="margin-left:20px;margin-bottom:20px"/> -->
			</div>
      <div class="row">
   ...
   <div class="span8">
         ...
         <div class="span4">
            <div class="pull-left">
               ...
               <select id="view" name="view" class="span2" onchange="change_view()">
                  <option selected="selected" value="search" />Details
                  <option value="small_search" />Small List
               </select>
            </div>
         </div>
      ...
      <div class="row">
         <div class="span2">
            ...
            <h5>Harga: Rp.<?php echo $row_pencarian->harga.' '.$row_pencarian->satuan_harga;?></h5>
            <?php
               ...
               ?>
            <h6>Tanggal: <?php echo date('d-m-Y',strtotime($row_pencarian->tgl_buat));?></h6>
            <h6>Di Lihat: <?php echo $row_pencarian->total_dilihat;?> kali</h6>
         </div>
         <div class="span6">
            <a href="<?php echo base_url().'property/show/' . $row_pencarian->id; ?>">
               <h3><?php echo substr('('.strtoupper($row_pencarian->tipe_listing).') '.$row_pencarian->judul_listing,0,40);?></h3>
            </a>
            <p><?php echo substr($row_pencarian->deskripsi_listing,0,300);?></p>
            <p>
              <!-- <a href="#" onclick="add_compare(<?php echo $row_pencarian->id;?>);return false">Bandingkan</a> |  -->
              <!-- <a href="#" onclick="add_bookmark(<?php echo $row_pencarian->id;?>);return false">Simpan</a> |  -->
              <a href="#myModal" data-toggle="modal" class="linkModal" onclick="set_value('<?php echo $row_pencarian->id_member . '/' . $row_pencarian->id; ?>')">Kirim Pesan ke Pengiklan</a>
            </p>
            <p>Di Iklankan oleh: <?php echo $row_pencarian->nama_lengkap . ". Telephon: " . $row_pencarian->telp;?></p>
         </div>
      </div>
      <hr />
      <?php
